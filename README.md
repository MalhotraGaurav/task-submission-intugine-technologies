This project is built using React.js using functional based components.The app is divided into reusable components that are present in the src folder of app.
